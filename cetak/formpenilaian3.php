...
$id = $_GET['id'];
$query ="SELECT u.npm, u.nama, u.prodi, u.judul, u.tanggal, u.jam, u.ruang, u.status, u.nip_penguji3, d3.nama as nama_penguji3, u.status_data 
    FROM tb_ujian_skripsi as u
    INNER JOIN tb_dosen as d3 ON d3.nip = u.nip_penguji3
...
$pdf->Cell(2,6,':',0,0,'L');
$pdf->Cell(70,6,$data['nama_penguji3'],0,1,'L');
//$pdf->Ln(2);
//$pdf->SetFont('arial','',12);
 //$pdf->SetFillColor(256,256,256);
 $pdf->Cell(10,6,'',0,0,'L');
...
$pdf->Cell(2,6,':',0,0,'L');
$pdf->Cell(70,6,$data['nip_penguji3'],0,1,'L');
...
$pdf->Cell(8,6,'',0,0,'C',1);
$pdf->Cell(100,6,'',0,0,'L',1);
$pdf->Cell(40,6,$data['nama_penguji3'],0,1,'L',1);
$pdf->SetFont('Arial','',12);
$pdf->Cell(10,6,'',0,0,'C');
$pdf->Cell(8,6,'',0,0,'C',1);
$pdf->Cell(100,6,'',0,0,'L',1);
$pdf->Cell(20,6,'NIP/NPP.',0,0,'L',1);
$pdf->Cell(50,6,$data['nip_penguji3'],0,1,'L',1);
...
// }
$pdf->Output('formpenilaian3.pdf','I');
}
?>			