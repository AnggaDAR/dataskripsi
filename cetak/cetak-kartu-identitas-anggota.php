...
$tgl=date('Y/m/d');
$pdf->Image('../dist/img/upgris-logo.png',5,5,100,56);
$pdf->Image('../dist/img/upgris-logo.png',106,5,100,56);
$pdf->Image('../dist/img/upgris-logo.png',10,9,10,10);
$pdf->Image('../dist/img/upgris-logo.png',80,29,20,25);
