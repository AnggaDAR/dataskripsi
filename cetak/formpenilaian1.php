...
$id = $_GET['id'];
$query ="SELECT u.npm, u.nama, u.prodi, u.judul, u.tanggal, u.jam, u.ruang, u.status, u.nip_penguji1, d1.nama as nama_penguji1, u.status_data 
...
//$pdf->SetFont('arial','',12);
 //$pdf->SetFillColor(256,256,256);
 $pdf->Cell(10,6,'',0,0,'L');
$pdf->Cell(70,6,'Nama Dosen Penguji I',0,0,'L');
$pdf->Cell(2,6,':',0,0,'L');
$pdf->Cell(70,6,$data['nama_penguji1'],0,1,'L');
//$pdf->Ln(2);
//$pdf->SetFont('arial','',12);
 //$pdf->SetFillColor(256,256,256);
 $pdf->Cell(10,6,'',0,0,'L');
...
$pdf->Cell(2,6,':',0,0,'L');
$pdf->Cell(70,6,$data['nip_penguji1'],0,1,'L');
