              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <?php
                    ...
                    $query = "SELECT * FROM tb_pesan WHERE username_pengirim = '$receiver'";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      $date = date('M d, Y H:i:s A', strtotime($row['waktu_kirim']));
                      echo "<tr>";
                      echo "<td><input type='checkbox'></td>";
                      echo "<td class='mailbox-star'><a href='#'><i class='fa fa-star text-yellow'></i></a></td>";
                      echo "<td class='mailbox-name'><a href='read-mail.php?id=".$row['id_pesan']."'> To : ".$row['username_penerima']."</a></td>";
                      echo "<td class='mailbox-subject'><b>".$row['subject']."</b> - ".strip_tags($row['pesan'])."</td>";
