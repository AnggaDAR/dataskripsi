              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                while ($row = mysqli_fetch_array($result)) {
                  // if ($n == 2) {
                    ...
                    echo "<td>" ./* $row[0] . "<br>" . */Hex2String(Encrypt32_64($row[0])) . /*"<br>" .Decrypt32_64(Encrypt32_64($row[0])).*/ "</td>";
                    echo "<td>" ./* $row[1] . "<br>" . */Hex2String(Encrypt32_64($row[1])) . /*"<br>" .Decrypt32_64(Encrypt32_64($row[1])).*/ "</td>";
                    echo "<td>" ./* $row[2] . "<br>" . */Hex2String(Encrypt32_64($row[2])) . /*"<br>" .Decrypt32_64(Encrypt32_64($row[2])).*/ "</td>";
                    echo "<td>" ./* $row[3] . "<br>" . */Hex2String(Encrypt32_64($row[3])) . /*"<br>" .Decrypt32_64(Encrypt32_64($row[3])).*/ "</td>";
                    echo "<td>" ./* $row[4] . "<br>" . */Hex2String(Encrypt32_64($row[4])) . /*"<br>" .Decrypt32_64(Encrypt32_64($row[4])).*/ "</td>";
                    echo "<td>" ./* $row[5] . "<br>" . */Hex2String(Encrypt32_64($row[5])) . /*"<br>" .Decrypt32_64(Encrypt32_64($row[5])).*/ "</td>";
                    echo "<td>" ./* $row[6] . "<br>" . */Hex2String(Encrypt32_64($row[6])) . /*"<br>" .Decrypt32_64(Encrypt32_64($row[6])).*/ "</td>";
                  ...
                  //   echo "<td>" . $row[6] . "</td>";
                  // }
                  // echo "<td>" . Padding32($row[0])."<br><br>". Encrypt32_64($row[0]) . "</td>";
                  // echo "<td>" . Padding32($row[1])."<br><br>". Encrypt32_64($row[1]). "</td>";
                  // echo "<td>" . Padding32($row[2])."<br><br>". Encrypt32_64($row[2]) . "</td>";
                  // echo "<td>" . Padding32($row[3])."<br><br>". Encrypt32_64($row[3]) . "</td>";
                  // echo "<td>" . Padding32($row[4])."<br><br>". Encrypt32_64($row[4]) . "</td>";
                  // echo "<td>" . Padding32($row[5])."<br><br>". Encrypt32_64($row[5]) . "</td>";
                  // echo "<td>" . Padding32($row[6])."<br><br>". Encrypt32_64($row[6]) . "</td>";
                    echo "<td><a href='edit_form.php?id=".$row[0]."' class='btn btn-block btn-primary btn-sm'><i class='fa fa-edit'></i> Edit </a>
                              <a href='delete_process.php?id=".$row[0]."' class='btn btn-block btn-danger btn-sm'><i class='fa fa-trash'></i> Hapus </a></td>";
                    echo "</tr>";
                  // }
                  $query2 = "";
                  $n++;
