...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="secret" placeholder="Masukkan Key Enkripsi">
              </div>
            </div>
            <div class="col-md-12">              
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Hasil Pembagian Kunci</h3>
              ...
              <?php
                if (!isset($_POST['submit'])) {
                  ...
                  for ($i=1; $i <= $nilai_n; $i++) {
                    ...
                    echo "<td>".$i."</td>";
                    echo "<td> Share-".$i."</td>";
                    echo "<td>".$share[$i]."mod".$nilai_m[$i]."</td>";
                    echo "</tr>";
                  }
                ...
                // $rem = array(1,12,2); 
                // $k = sizeof($num);
                // $scrt = findMinXa($num, $rem, $k) % $nilai_m[0];
                // echo "x is ".findMinXb($num, $rem, $k)."<br>";
